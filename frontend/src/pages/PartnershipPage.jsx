    ...
    <div className="partnership-page">
      ...
      <section className="partnership-hero">
        <div className="section-container">
          <h1 className="partnership-hero-title">Our Strategic Partners</h1>
          <p className="partnership-hero-subtitle">
            Building the future together through collaboration and innovation
          </p>
        </div>
        <div className="partnership-hero-pattern"></div>
      </section>
        ...
        <div className="section-container">
          <div className="featured-partner-card">
            <div className="partner-left">
              ...
              <h2 className="partner-company-name">AIkara AI</h2>
            ...
            <div className="partner-right">
              ...
              <div className="collaboration-areas">
                <h3 className="collaboration-title">Key Collaboration Areas</h3>
        ...
        <div className="section-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Strategic partnerships that amplify our capabilities and drive mutual success
            </p>
          </div>
      ...
      {/* Future Partners CTA */}
      <section className="future-partners-section">
        <div className="section-container">
          <div className="future-partners-content">
            <h2 className="future-partners-title">Interested in Partnership?</h2>
            <p className="future-partners-description">
              We're always looking for strategic partners who share our vision for innovation and excellence. Let's explore how we can create value together.
            </p>
            <button 
